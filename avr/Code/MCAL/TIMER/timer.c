...
/*// NOT YET
EN_timer2Error_t TIMER2_init(ST_timer2_t *ptr_timer2)
{
	EN_timer0Error_t ret = TIMER0_OK;

	switch (ptr_timer2->mode)
	{
	case TIMER2_NORMAL:
	...
	default:
		ret = TIMER2_WRONG_MODE;
		break;
	}

	switch (ptr_timer2->preScaler)
	{
	case TIMER2_STOP:
	...
	case EXTERNAL2_RISING:
		...
		break;
	default:
		ret = TIMER2_WRONG_PRESCALER;
		break;
	}

	switch (ptr_timer2->ocMode)
	{
...
{
	EN_timer2Error_t ret = TIMER2_OK;
	return ret;
}
